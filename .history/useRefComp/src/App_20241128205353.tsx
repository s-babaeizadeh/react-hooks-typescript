...
const App = () => {
  ...
  return (
    <div>
      ...
      <button
        onClick={focusInput}
        className="p-3 bg-red-500 hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded"
      >
        Focus
      </button>
      <h2>{text}</h2>
